...
let aboutRandom = document.getElementById('aboutRandom');
let aboutCalculator = document.getElementById('aboutCalculator');
let aboutLucky = document.getElementById('aboutLucky');

let contRandom = document.querySelector('#contRandom');
let min = document.querySelector('#min');
let max = document.querySelector('#max');
let generate = document.querySelector('#generate');
let result = document.querySelector('#result');

let contCalc = document.querySelector('#contCalc');
let contLucky = document.querySelector('#contLucky');

random.addEventListener("click", choiceRandom);
calc.addEventListener("click", choiceCalc);
lucky.addEventListener("click", choiceLucky);

aboutRandom.addEventListener("click", choiceRandom);
aboutCalculator.addEventListener("click", choiceCalc);
aboutLucky.addEventListener("click", choiceLucky);

function choiceRandom() {
  index.className = "blog-nav-item";
  random.className = "blog-nav-item active";
