          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <span>
                      <img class="img200" src="/template<?=$newsItem['preview'];?>" alt="picture">
                  ...
                  <div class="col-lg-12">
                    ...
                    <!-- <div class="white-button scroll-to-section">
                      <a href="#contact">Free Quote <i class="fab fa-google-play"></i><i class="fab fa-apple"></i></a>
                    </div> -->
                  </div>
                </div>
                <?php endforeach;?>
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="/template/assets/images/slider-dec.png" alt="">
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <br>Design: <a href="#" target="_blank" title="css /templates">/templateMo</a><br>
        
          Distributed By: <a href="#" target="_blank" title="Bootstrap /template World">ThemeWagon</a>
        </p>
          </div>
        </div>
      </div>
